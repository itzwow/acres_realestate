...
export default function Listing() {
  ...
  return (
    <main>
      ...
      <div
        className="fixed top-[13%] right-[3%] z-10 cursor-pointer border bg-white w-10 h-10 rounded-full flex justify-center items-center"
        onClick={() => {
      ...
      <div className="m-4 flex flex-col md:flex-row max-w-6xl lg:mx-auto p-4 bg-white rounded-lg lg:space-x-5">
        <div className=" w-full ">
          ...
          <ul className="flex items-center justify-between">
            ...
            <li className="flex items-center space-x-3">
              <MdChair className="mr-2 text-xl" />{" "}
              {listing.furnished ? "Furnished" : "Not Furnished"}
            </li>
          </ul>
          {!contactLandlord && auth.currentUser !== listing.userRef && (
            <div className="mt-5 mb-3 p-4">
              <button
                onClick={onChange}
        ...
        <div className=" w-full h-[200px] z-10 overflow-x-hidden md:h-[400px]">
