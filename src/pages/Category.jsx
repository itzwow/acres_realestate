  ...
  export default function Category() {
    ...
    return (
      <div className="max-w-6xl mx-auto px-3">
        <h1 className="text-3xl text-center mt-6 font-bold">{params.categoryType==="rent"?"Places for Rent": "Places for Sale"}</h1>
        {loading ? (
          <Spinner />
          ...
          <p>No more listings {params.categoryType==="rent"?"for Rent": "for Sale"}</p>
        )}
      </div>
    );
  }
